...
- [Regenerating the replay fixture needs the memory service on make's port](references/reference_capture_history_port.md) — make capture-history reaches memory on the Casper-remapped MEMORY_PORT (e.g. 40304), not 8010; wrong port yields a broken applied:false fixture.
